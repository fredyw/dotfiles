...
export NODE_HOME=$HOME/data/node-v0.12.1-linux-x64
export SBT_HOME=$HOME/data/sbt-0.13.8
export GOPATH=$HOME/data/goprojects
export LITEIDE_HOME=$HOME/data/liteide
export PATH=$HOME/data/bin:$JAVA_HOME/bin:$ECLIPSE_HOME:$SCALAIDE_HOME:$ADT_HOME/eclipse:$ADT_HOME/sdk/platform-tools:$ADT_HOME/sdk/android:$GOROOT/bin:$WAF_HOME:$GRADLE_HOME/bin:$ANT_HOME/bin:$M2_HOME/bin:$SCALA_HOME/bin:$GROOVY_HOME/bin:$NODE_HOME/bin:$SBT_HOME/bin:$GOPATH/bin:$LITEIDE_HOME/bin:$PATH
